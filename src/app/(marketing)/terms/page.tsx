      ...
      <section className="px-6 py-24">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-12 space-y-8 text-gray-700">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900">7. Subscriptions and Renewals</h2>
              <p className="mt-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900">8. Cancellation and Refunds</h2>
              <p className="mt-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900">9. Third-Party Services and Links</h2>
              <p className="mt-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900">16. Changes to Terms</h2>
              <p className="mt-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900">17. Severability</h2>
              <p className="mt-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900">18. Entire Agreement</h2>
              <p className="mt-4">
